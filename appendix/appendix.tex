...
\begin{figure}[ht]
\centering
\subfloat[]{\includegraphics[width=0.45\linewidth]{appendix/install/1/install1.eps}} \hspace{5mm}
\subfloat[]{\includegraphics[width=0.45\linewidth]{appendix/install/1/install2.eps}}\\
\subfloat[]{\includegraphics[width=0.45\linewidth]{appendix/install/1/install3.eps}} \hspace{5mm}
\subfloat[]{\includegraphics[width=0.45\linewidth]{appendix/install/1/install4.eps}}\\
\subfloat[]{\includegraphics[width=0.45\linewidth]{appendix/install/1/install5.eps}} \hspace{5mm}
\subfloat[]{\includegraphics[width=0.45\linewidth]{appendix/install/1/install6.eps}}\\
